...
struct TscTimePoint {
    ...
    shared static this() {
        cyclesPerSec = MonoTime.ticksPerSecond;
    }
    ...
    static Duration toDuration(ulong cycles) {
        return (cycles / cyclesPerSec) * dur!"seconds"(1) + (cycles % cyclesPerSec) * HECTONANO / cyclesPerSec * dur!"hnsecs"(1);
    }

    static TscTimePoint hardNow() {
        return TscTimePoint(MonoTime.currTime.ticks);
    }
}
